...
<head>
	...
	<link rel="stylesheet" href="{{constant('ramenApp\\Bootstrap::APP_URL')}}css/assets/css/main.css" />
	<noscript>
		<link rel="stylesheet" href="{{constant('ramenApp\\Bootstrap::APP_URL')}}css/assets/css/noscript.css" /></noscript>
</head>
...
<body class="is-preload">
	...
	<div id="wrapper">
		...
		<div id="main">
			<div class="inner">
				<h1>{{dataArr.name}}</h1>
				<h2> 味:{{dataArr.taste}}</h2>
				<span class="image main"><img src="{{constant('ramenApp\\Bootstrap::APP_URL')}}/pic/{{dataArr.pic}}" alt="" width="900" height="600" /></span>
				<p>{{dataArr.introduction}}</p>
			</div>
		</div>
